...
buttons = Button.create!([
  ...
  { assignment: '3', story: Story.find_by_title('Speak'), phone: phones[] },
  { assignment: '1', story: Story.find_by_title('If I Stay'), phone: phones[] },
  { assignment: '5', story: Story.find_by_title('The Spectacular Now'), phone: phones[] },
  { assignment: '8', story: Story.find_by_title('Feed'), phone: phones[] },
  { assignment: '6', story: Story.find_by_title('Where’d You Go Bernadette'), phone: phones[] },
  { assignment: '2', story: Story.find_by_title('The Perks of Being A Wallflower'), phone: phones[] },
  { assignment: '4', story: Story.find_by_title('A Prayer for Owen Meany'), phone: phones[] },
  { assignment: '7', story: Story.find_by_title('Eleanor & Park'), phone: phones[] },
  { assignment: '9', story: Story.find_by_title('Bossy Pants'), phone: phones[] },
])
