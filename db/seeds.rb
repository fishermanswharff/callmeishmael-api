...
buttons = Button.create!([
  ...
  { assignment: '3', story: Story.find_by_title('Speak'), phone: phones[1] },
  { assignment: '1', story: Story.find_by_title('If I Stay'), phone: phones[1] },
  { assignment: '5', story: Story.find_by_title('The Spectacular Now'), phone: phones[1] },
  { assignment: '8', story: Story.find_by_title('Feed'), phone: phones[1] },
  { assignment: '6', story: Story.find_by_title('Where’d You Go Bernadette'), phone: phones[1] },
  { assignment: '2', story: Story.find_by_title('The Perks of Being A Wallflower'), phone: phones[1] },
  { assignment: '4', story: Story.find_by_title('A Prayer for Owen Meany'), phone: phones[1] },
  { assignment: '7', story: Story.find_by_title('Eleanor & Park'), phone: phones[1] },
  { assignment: '9', story: Story.find_by_title('Bossy Pants'), phone: phones[1] },
])
